...
window.SITE_DATA = {
  ...
  /* ---- Home: about the lab --------------------------------------------- */
  about: `The EARP Lab — Experimental Bioethics, Artificial Intelligence, and Relational Moral Psychology — is directed by Associate Professor Brian D. Earp at the Centre for Biomedical Ethics, Yong Loo Lin School of Medicine, National University of Singapore. We study how people actually reason about moral questions in medicine, technology, and close relationships, and we use those findings to inform ethical theory and practice. Our work combines controlled behavioural experiments, conceptual analysis, and cross-cultural and computational methods, spanning psychology, philosophy, and bioethics.`,
